...
class StoreProjectWorkersRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'worker_ids.*'  => ['integer',Rule::exists('team_user','user_id')->where('team_id',$this->project->team_id)],
        ];
    }
    ...
    {
        return[
            'worker_ids.required'   => 'The worker is required please',
